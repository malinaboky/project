...
def sen_export_excel_cogdev(reguest):
    response = HttpResponse(content_type='application/ms-excel')
    response['Content-Disposition'] = 'attachment; filename="{}{}{}"'.format('Poznavatelnoe_razvitie_starshaya_grupa', datetime.datetime.now().date(), '.xls')
...
def sen_export_excel_speechdev(reguest):
    response = HttpResponse(content_type='application/ms-excel')
    response['Content-Disposition'] = 'attachment; filename="{}{}{}"'.format('Rechevoe_razvitie_starshaya_grupa', datetime.datetime.now().date(), '.xls')
...
def sen_export_excel_comdev(reguest):
    response = HttpResponse(content_type='application/ms-excel')
    response['Content-Disposition'] = 'attachment; filename="{}{}{}"'.format('Soc_razvitie_starshaya_grupa', datetime.datetime.now().date(), '.xls')
...
def sen_export_excel_physdev(reguest):
    response = HttpResponse(content_type='application/ms-excel')
    response['Content-Disposition'] = 'attachment; filename="{}{}{}"'.format('Phyzicheskoe_razvitie_starshaya_grupa', datetime.datetime.now().date(), '.xls')
...
def sen_export_excel_artdev(reguest):
    response = HttpResponse(content_type='application/ms-excel')
    response['Content-Disposition'] = 'attachment; filename="{}{}{}"'.format('Hyd_Razvitie_starshaya_grupa', datetime.datetime.now().date(), '.xls')
...
def sen_export_excel_psycho(reguest):
    response = HttpResponse(content_type='application/ms-excel')
    response['Content-Disposition'] = 'attachment; filename="{}{}{}"'.format('Psiholog_starshaya_grupa', datetime.datetime.now().date(), '.xls')
...
def sen_export_excel_eyes(reguest):
    response = HttpResponse(content_type='application/ms-excel')
    response['Content-Disposition'] = 'attachment; filename="{}{}{}"'.format('Zrenie_starshaya_grupa', datetime.datetime.now().date(), '.xls')
...
def get_tables_psycho_eyes(table, main_exel):
    values_table = apps.get_app_config('senior_group').get_model(table)

...
class UpdateSpeechActivitySerializer(serializers.ModelSerializer):
    def update(self, instance: SpeechActivity, validated_data):
        ...
        instance.param10 = validated_data.get('param10', instance.param10)
        instance.param11 = validated_data.get('param11', instance.param11)
        instance.param12 = validated_data.get('param12', instance.param12)
        instance.param13 = validated_data.get('param13', instance.param13)
        instance.param14 = validated_data.get('param14', instance.param14)
        instance.param15 = validated_data.get('param15', instance.param15)
        instance.param16 = validated_data.get('param16', instance.param16)
        instance.param17 = validated_data.get('param17', instance.param17)
        instance.param18 = validated_data.get('param18', instance.param18)
        instance.param19 = validated_data.get('param19', instance.param19)
        instance.param20 = validated_data.get('param20', instance.param20)
        instance.param21 = validated_data.get('param21', instance.param21)

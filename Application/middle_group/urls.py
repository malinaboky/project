...
urlpatterns = [
    ...
    path('mid_export_excel_cogdev', sources.mid_export_excel_cogdev, name='mid_export_excel_cogdev'),
    path('mid_export_excel_speechdev', sources.mid_export_excel_speechdev, name='mid_export_excel_speechdev'),
    path('mid_export_excel_comdev', sources.mid_export_excel_comdev, name='mid_export_excel_comdev'),
    path('mid_export_excel_physdev', sources.mid_export_excel_physdev, name='mid_export_excel_physdev'),
    path('mid_export_excel_artdev', sources.mid_export_excel_artdev, name='mid_export_excel_artdev'),
    path('mid_export_excel_psycho', sources.mid_export_excel_psycho, name='mid_export_excel_psycho'),
    path('mid_export_excel_eyes', sources.mid_export_excel_eyes, name='mid_export_excel_eyes'),
]

...
urlpatterns = [
    ...
    path('export_excel_cogdev', sources.export_excel_cogdev, name='export_excel_cogdev'),
    path('export_excel_speechdev', sources.export_excel_speechdev, name='export_excel_speechdev'),
    path('export_excel_comdev', sources.export_excel_comdev, name='export_excel_comdev'),
    path('export_excel_physdev', sources.export_excel_physdev, name='export_excel_physdev'),
    path('export_excel_artdev', sources.export_excel_artdev, name='export_excel_artdev'),
    path('export_excel_psycho', sources.export_excel_psycho, name='export_excel_psycho'),
    path('export_excel_eyes', sources.export_excel_eyes, name='export_excel_eyes'),
]

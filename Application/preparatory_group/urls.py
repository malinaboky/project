...
urlpatterns = [
    ...
    path('pre_export_excel_cogdev', sources.pre_export_excel_cogdev, name='pre_export_excel_cogdev'),
    path('pre_export_excel_speechdev', sources.pre_export_excel_speechdev, name='pre_export_excel_speechdev'),
    path('pre_export_excel_comdev', sources.pre_export_excel_comdev, name='pre_export_excel_comdev'),
    path('pre_export_excel_physdev', sources.pre_export_excel_physdev, name='pre_export_excel_physdev'),
    path('pre_export_excel_artdev', sources.pre_export_excel_artdev, name='pre_export_excel_artdev'),
    path('pre_export_excel_psycho', sources.pre_export_excel_psycho, name='pre_export_excel_psycho'),
    path('pre_export_excel_eyes', sources.pre_export_excel_eyes, name='pre_export_excel_eyes'),
]
